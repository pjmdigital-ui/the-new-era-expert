 ...
 * slide, an optional presenter-only delivery note visually separated from
 * the script.
 */
...
- guidance (optional): a brief delivery note for the presenter only (e.g. "pause here," "lean in") — never something the presenter would say out loud
 ...
 * @returns {Promise<Array<{headline: string, body: string, guidance?: string, size: string}>>}
 */
