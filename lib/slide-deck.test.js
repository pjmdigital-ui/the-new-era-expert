...
test('buildSlideDeckPrompt includes the topic title, the entry-point belief goal, the never-write-instructions requirement, and the phrasing-avoidance rules', () => {
  ...
  assert.ok(prompt.includes('quietly'));
});
