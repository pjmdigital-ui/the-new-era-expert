 ...
 * of which font actually renders. Font-family references "Archivo Black"
 * directly (not a system-font fallback stack like "Arial, Helvetica,
 * sans-serif") because that's the exact font lib/thumbnail-render.js
 * fetches and supplies to resvg — Cloudflare Workers have no system fonts,
 * so a fallback stack of fonts that don't exist there would never resolve.
 *
