 ...
 * SVG alongside the AI-generated background <image>. Split out from
 * buildThumbnailTextSVG (below) so the route doesn't have to nest a second
 * full <svg> document inside the composite one.
 *
 * @param {Object} opts
